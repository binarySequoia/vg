...
vg gamcompare -r 100 mapped.gam sim.gam | vg recalibrate -b -o --model recal.modelbo --train -
is $? 0 "vg recalibrate bag of words without mapping qualities model training complete successfully"
...
vg recalibrate -s --model recal.models mapped.gam  > /dev/null
is $? 0 "vg recalibrate mems stats model prediction complete successfully"

vg recalibrate -b -o --model recal.modelbo mapped.gam  > /dev/null
is $? 0 "vg recalibrate bag of words without mapping qualities prediction complete successfully"
